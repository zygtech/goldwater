...
<tr><td></td><td><input type="submit" value="INVITE NEW USER" /></td></tr>
<?php
	if ($user['id']!=1) 
		echo '<tr><td></td><td><a href="deleteuser.php?id=' . $user['id'] . '">DELETE CURRENT USER</a></td></tr>';
?>
</table>
</div>
</form>
...
<tr><td>LICENSE KEY:</td><td><?php if ($_SESSION['company']!='goldwater') echo '<a href="https://gumroad.com/subscriptions/' . $_SESSION['subscribtion'] . '/manage" target="_blank">'; else echo '<a href="#">'; ?><?php echo $info['license']; ?></a></td></tr>
...
<tr><td>CHANGE:</td><td><input id="logo" type="file" name="logo" accept=".jpg,.png" /><label for="logo">CHANGE LOGO</label></td></tr>
