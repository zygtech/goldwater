...
<?php
	...
	<table class="top"><tr><td style="background: lightgray;">Quote</td><td style="background: #e7e7e8;">' . $row['quoteid'] . '</td><td></td><td></td><td style="background: lightgray;">Date</td><td style="background: #e7e7e8;">' . $row['creation'] . '</td></table>
	<table class="main"><tr><th style="background: ' . $info['color'] . ';">Client\'s name:</th><th style="background: ' . $info['color'] . ';"></th><th style="background: ' . $info['color'] . ';"></th></tr>
