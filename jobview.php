...
<?php
	...
	<table class="top"><tr><td style="background: lightgray;">Job</td><td style="background: #e7e7e8;">' . 'JB' . sprintf('%04d',$_GET['id']) . '</td><td></td><td></td><td style="background: lightgray;">Date</td><td style="background: #e7e7e8;">' . $row['creation'] . '</td></table>
	<table class="main description">';
	if ($row['name']!='') $html .= '
		<tr><th style="background: ' . $info['color'] . ';">Job name</th></tr>
	...
	if ($row['stage']!='') $html .= '
	<tr><th style="background: ' . $info['color'] . ';">Stage</th></tr>
	...
	<tr><th style="background: ' . $info['color'] . ';">Required by</th></tr>
