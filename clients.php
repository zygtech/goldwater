...
?>
	<h1 style="float: left;">Clients</h1><span style="float: right;"><a href="client.php"><i class="fa fa-plus" aria-hidden="true"></i> Add a client</a></span><br /><br />
	<table class="data">
	<?php
	...
	?><br />
	<input type="submit" value="Send e-mail" /></center></form>
<?php
