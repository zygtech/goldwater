...
<?php
	...
	<table>
	<tr><td>Invoice ID:<br /><input type="text" name="invoiceid" value="<?php if ($invoice['invoiceid']!='') echo $invoice['invoiceid']; ?>" /></td>
	...
	<td style="width: 10% !important;">Netto</td><td style="width: 10% !important;">VAT (%)</td><td style="width: 10% !important;">VAT value</td><td style="width: 10% !important;">Total</td></tr>
	<?php for($i=0;$i<20;$i++) {
	...
	<table><tr><th>Bank Info</th><th>Currency</th></tr>
	...
	</select></td></tr><tr><th>Total</th></tr><tr><td><div id="total" class="field"><?php echo number_format($invoice['total'],2,'.',''); ?>
	</div></td></tr></table>
	<table><tr><th>Additional info:</th></tr><tr><td><input type="text" name="info" value="<?php echo $invoice['info']; ?>" /></td></tr></table>
	<table>
