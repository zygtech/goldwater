...
?>
	<h1 style="float: left;">Quotes</h1><span style="float: right;"><a href="quote.php"><i class="fa fa-plus" aria-hidden="true"></i> Add a quote</a></span><br /><br />
	<table class="data">
	<?php
		...
		?>
			<tr><th style="width: 20%;"><a href="quotes.php?sort=quoteid<?php if ($_GET['sort']=='quoteid' && $_GET['order']=='') echo '&order=DESC'; ?><?php if ($_GET['q']!='') echo '&q=' . $_GET['q']; ?>">QUOTE ID</a></th><th style="width: 30%;"><a href="quotes.php?sort=name<?php if ($_GET['sort']=='name' && $_GET['order']=='') echo '&order=DESC'; ?><?php if ($_GET['q']!='') echo '&q=' . $_GET['q']; ?>">QUOTE NAME</a></th><th style="width: 15%;"><a href="quotes.php?sort=added<?php if ($_GET['sort']=='added' && $_GET['order']=='') echo '&order=DESC'; ?><?php if ($_GET['q']!='') echo '&q=' . $_GET['q']; ?>">BY</a></th><th style="width: 23%;"><a href="quotes.php?sort=company<?php if ($_GET['sort']=='company' && $_GET['order']=='') echo '&order=DESC'; ?><?php if ($_GET['q']!='') echo '&q=' . $_GET['q']; ?>">CLIENT</a></th><th style="width: 15%;"><a href="quotes.php?sort=creation<?php if ($_GET['sort']=='creation' && $_GET['order']=='') echo '&order=DESC'; ?><?php if ($_GET['q']!='') echo '&q=' . $_GET['q']; ?>">DATE</a></th><th></th><th></th><th></th></tr>
		<?php
		$p=1; $l=0;
