...
<?php
	...
	$query = 'UPDATE `' . $_SESSION['company'] . '_info` SET display="' . $_POST['display'] . '", address="' . $_POST['address'] . '", contact="' . $_POST['contact'] . '", bank="' . $_POST['bank'] . '", color="' . $_POST['color'] . '", currency="' . $_POST['currency'] . '", productlist=' . $products . ' WHERE id=1;';
