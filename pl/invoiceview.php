...
<?php
	...
	<table class="top"><tr><td style="background: lightgray;">Faktura</td><td style="background: #e7e7e8;">' . $row['invoiceid'] . '</td><td></td><td></td><td style="background: lightgray;">Data</td><td style="background: #e7e7e8;">' . $row['creation'] . '</td></table>
	<table class="main"><tr><th style="background: ' . $info['color'] . ';">Dane firmy:</th><th style="background: ' . $info['color'] . ';"></th><th style="background: ' . $info['color'] . ';"></th></tr>
	<tr><td>' . $info['display'] . '<br />' . str_replace("\n","<br />",$info['address']) . '</td>
	<td><strong>KONTAKT:</strong><br />' . str_replace("\n","<br />",$info['contact']) . '</td>
	<td style="width: 45%;"><strong>BANK:</strong><br />' . str_replace("\n","<br />",$row['bank']) . '</td>
	</table>
    ...
    Ten dokument stanowi oryginalną wersję elektroniczną.
	</div>
	</div>
	</body>';
}
