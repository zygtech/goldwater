...
?>
	<h1 style="float: left;">Tasks</h1><br /><br />
	<table class="data">
	<?php
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			if ($_GET['q']=='' || strpos(strtolower($row['name']), strtolower($_GET['q']))!==false) {				
				...
				if ($row['archive']==0)
					...
					echo '<td style="width: 3%;"><a href="taskedit.php?id=' . $row['id'] . '&job=' . $row['jobid'] . '&return=s" title="Task revive"><i class="fa fa-undo" aria-hidden="true"></i></a></td><td style="width: 3%;">';	
